...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      String? output = "${input.year}-${input.month.toString().padLeft(2, '0')}-${input.day.toString().padLeft(2, '0')}";
  ...
  output = input;
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<int> input = [1, 2, 3, 4, 5];
      bool? output = input.toString().contains("3");
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<String> input = ["apple", "banana", "cherry"];
      bool? output = input.toString().contains("grape");
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<String> input = ["apple", "banana", "cherry"];
      Map<String, String>? output = {for (var e in input) e: e};
      // --- End of Answer ---
    ...
    () {
      ...
      Map<int, String>? output = {
        for (var e in input.split(',')) int.parse(e): "value"
      };
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<Map<String, int>> input = [{"amount": 5}, {"amount": 10}, {"amount": 3}];
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<Map<String, dynamic>> input = [{"value": 7}, {"value": 15}, {"value": 9}];
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      String input = "apple,banana,cherry,dates,elderberry";
      Map<String, int>? output = input.split(",").asMap().map((_, e) => MapEntry(e, e.length));
      // --- End of Answer ---
    ...
    () {
      ...
      Map<String, int>? output = Map.fromEntries(
        input.split(",").map((e) {
          var parts = e.split(":");
    ...
    () {
      ...
      Map<String, double>? output = Map.fromEntries(
        input.split(",").map((e) {
          var parts = e.split(":");
    ...
    () {
      ...
      Map<String, bool>? output = Map.fromEntries(
        input.split(",").map((e) {
          var parts = e.split(":");
    ...
    () {
      ...
      Map<String, DateTime>? output = Map.fromEntries(
        input.split(",").map((e) {
          var parts = e.split(":");
    ...
    () {
      ...
      int price = 100;
      String convertedPrice = price.toString();
      return convertedPrice is String;
    },
    ...
    () {
      ...
      price = double.tryParse(cleanedText) ?? 0;
      return price == 300.24;
    },
    ...
    */
    ...
    () {
      ...
      bool output = (input * 100).toInt() % 100 == 45;
      return output == true;
    },
    ...
    () {
      ...
      bool output = (input * 1000).toInt() % 10 == 0;
      return output == true;
    },
    ...
    () {
      ...
      bool output = numbers.every((num) => num % 2 == 0);
      return output == false;
    },
